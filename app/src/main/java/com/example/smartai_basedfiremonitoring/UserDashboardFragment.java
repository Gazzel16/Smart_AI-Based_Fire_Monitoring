    ...
    public class UserDashboardFragment extends Fragment {
        ...
        TextView flameOutput, flameDetector,tempLevel,
                tempStatus, humidLevel, humidStatus, smokeOutput, smokeStatus;
        @Nullable
        @Override
        public View onCreateView(@NonNull LayoutInflater inflater,
            ...
            tempLevel = view.findViewById(R.id.tempLevel);
            tempStatus = view.findViewById(R.id.tempStatus);

            humidLevel = view.findViewById(R.id.humidLevel);
